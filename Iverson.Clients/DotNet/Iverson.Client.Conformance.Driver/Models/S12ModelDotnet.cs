...
/// only to carry <c>[IversonEmbeddingModel("BAAI/bge-base-en-v1.5")]</c> for <see cref="S12InheritedDotnet"/>
...
/// nothing of its own — it inherits <c>[IversonEmbeddingModel("BAAI/bge-base-en-v1.5")]</c> from
