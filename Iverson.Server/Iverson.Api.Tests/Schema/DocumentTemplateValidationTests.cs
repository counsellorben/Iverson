...
public class DocumentTemplateValidationTests
{
    ...
    public async Task RegisterAsync_OneHopScalarNotOnTargetType_ThrowsInvalidArgument()
    {
        ...
        root.Properties.Add(new PropertyDescriptor { Name = "OwnerId", ClrType = ClrType.ClrGuid });
        root.Relations.Add(new Client.Contracts.RelationDescriptor
        {
            PropertyName = "Owner", Kind = Client.Contracts.RelationKind.ManyToOne, RelatedType = "User", ForeignKey = "OwnerId"
        });
    ...
    public async Task RegisterAsync_RetargetingTypeDropsPropertyADependentTemplateReferences_ThrowsFailedPrecondition()
    {
        ...
        article.Properties.Add(new PropertyDescriptor { Name = "AuthorId", ClrType = ClrType.ClrGuid });
        article.Relations.Add(new Client.Contracts.RelationDescriptor
        {
            PropertyName = "Author", Kind = Client.Contracts.RelationKind.ManyToOne, RelatedType = "User", ForeignKey = "AuthorId"
        });
